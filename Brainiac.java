...
class Brainiac {
	...
	private static double erro = 0.00001;
	...
	public static void main(String[] args) {
		...
		try{
			FileWriter escritor = new FileWriter("Treinamentos/funcao_um_arq_dois_aprox.funcao");
			PrintWriter saida = new PrintWriter(escritor, true);
			...
			System.out.println("Erro no salvamento da f1a2: " + e.getMessage());
		}
		...
		try{
			FileWriter escritor = new FileWriter("Treinamentos/funcao_um_arq_tres_aprox.funcao");
			PrintWriter saida = new PrintWriter(escritor, true);
			...
			System.out.println("Erro no salvamento da f1a3: " + e.getMessage());
		}
		...
		r.inicializarPesos();
		r.carregarConjuntos("Dados/funcao_dois_treino.conjunto", "Dados/funcao_dois_val.conjunto");
		r.treinamento(epoca, erro, n);
		r.salvarRede(r.getTreino());

		try{
			FileWriter escritor = new FileWriter("Treinamentos/funcao_dois_arq_um_aprox.funcao");
			PrintWriter saida = new PrintWriter(escritor, true);
			...
			System.out.println("Erro no salvamento da f2a1: " + e.getMessage());
		}
		...
		try{
			FileWriter escritor = new FileWriter("Treinamentos/funcao_dois_arq_dois_aprox.funcao");
			PrintWriter saida = new PrintWriter(escritor, true);
			...
			System.out.println("Erro no salvamento da f2a2: " + e.getMessage());
		}
		...
		try{
			FileWriter escritor = new FileWriter("Treinamentos/funcao_dois_arq_tres_aprox.funcao");
			PrintWriter saida = new PrintWriter(escritor, true);
			...
			System.out.println("Erro no salvamento da f2a3: " + e.getMessage());
		}
